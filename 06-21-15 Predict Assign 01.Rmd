...
set.seed(444)
system.time(svmFit <- train(classe ~., data = pmlTraininDF, method = "svmRadial",
...
set.seed(532)
system.time(gbmFit <- train(classe ~., data = pmlTraininDF, method = "gbm",
                preProcess = c("center", "scale"), trControl = gbmTrain))
...
set.seed(621)
system.time(rfFit <- train(classe ~., data = pmlTraininDF, method = "rf",
